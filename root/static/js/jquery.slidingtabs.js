...
(function($) { 
	...
	$.fn.slideTabs = function(options) {
		...
		this.each(function() {				
			...
			tabs.find("li a."+opts.tabClass).live("click", function() {
				...
				view = content.children("div#"+tab.attr("href"));								
			...
			function slideLeft() {
				  ...
				  view.css({display: "block"}).animate({left: 0+"px"}, opts.contentAnimTime, opts.contentEasing, function() {				
	...
	$.fn.slideTabs.defaults = {
		...
		btnPrev: "a.prev",
		tabsList: "ul.tabs",
		viewContainer: ".tabs-view-container",		
		tabClass: "tab",
		activeTabClass: "active",
		activeViewClass: "active-view",
