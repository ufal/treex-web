...
angular.module('TreexWebApp')
  .directive('twTable', ['$compile', '$parse', function($compile, $parse) {
    var template = '<thead> \
    <tr> \
      <th class="header" \
    ...
    return {
      ...
      compile: function(element, attrs) {
        ...
        return function(scope, element, attrs) {
          scope.callback = scope[attrs.twTable];
